//
//  KCKSingleButtonMessageAlertView.swift
//  Kiriha
//
...
open class KCKSingleButtonMessageAlertView: KCKSingleButtonAlertView {
     ...
     */
    public static func show(title: String?, message: String, inViewController: Bool = false, viewConfiguration: ((_ messageAlertView: KCKSingleButtonMessageAlertView) -> Void)?, confirmAction: @escaping (() -> Void)) {
        let messageAlertView: KCKSingleButtonMessageAlertView = KCKSingleButtonMessageAlertView()
